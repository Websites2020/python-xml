...
#  shoppingList_method.py
#  This is a complex Python program that reads a shopping list from an xml file and allows the user to add items to their shopping list.  I also added the ability for the user to delete all the items off their shopping list and broke my code up into a method, both of which I did not have in the complex Perl program.  I'm very happy at how this turned out.
...
#  To run this program simply type "python shoppingList_method.py" and then follow the prompts.

# Create a method (def) called my_method
